...
from dataset import CMU_Hand_Manual, CMU_Panopticdb
...
#CMU_Hand_Manual model train config
...
if __name__ == "__main__":
    ...
    for epoch in range(model_dict['epoch'], 5000):
        ...
        train_loss, train_acc = train(model, train_dataset, train_loader, criterion, optimizer, epoch, train_print_freq)
        ...
        val_loss, val_acc = val(model, val_dataset, val_loader, criterion, epoch, val_print_freq)
